...
csl: ../apa.csl
vignette: >
  %\VignetteIndexEntry{Alternative optimization engine for fitting detection functions}
...
This vignette demonstrates how to download and then use the MCDS.exe software from within the `Distance` and `mrds` packages.  For more information, see the `MCDS.exe` help page within the `mrds` package.
