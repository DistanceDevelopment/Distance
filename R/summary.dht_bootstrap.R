...
#'
#' Summaries are only made for numeric outputs. Both median and mean are reported to allow assessment of bias. The cofficient of variation reported (in column \code{cv}) is based on the median calculated from the bootstraps.
#'
